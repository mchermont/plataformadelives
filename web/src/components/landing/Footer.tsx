      ...
      <section className="bg-[var(--gl-brand)] py-20 text-white">
        <Reveal className="mx-auto max-w-2xl px-4 text-center sm:px-6">
          ...
          <a
            ...
            className="mt-8 inline-flex items-center gap-2 rounded-full bg-white px-7 py-3.5 text-base font-semibold text-[var(--gl-brand)] transition hover:-translate-y-0.5"
          >
