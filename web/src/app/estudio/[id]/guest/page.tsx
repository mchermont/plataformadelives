  ...
  return (
    <div className="flex min-h-screen w-full flex-col gap-4 overflow-y-auto bg-neutral-950 p-3 text-neutral-100 lg:h-screen lg:flex-row lg:overflow-hidden lg:p-4">
      ...
      <div className="flex w-full flex-shrink-0 flex-col items-center gap-3 lg:min-h-0 lg:flex-1 lg:justify-center">
        ...
        {/* Player Rígido 16:9 — em vez de recompor a cena localmente (cada
            convidado calculando o próprio layout, o que já causou bug
            visual diferente em cada tela), embute a MESMA URL que o
            Egress captura pro YouTube (`/output`), com baixa latência via
            LiveKit em vez do delay do YouTube. Mudo por padrão — já está
            ouvindo todo mundo ao vivo pela própria sala. */}
